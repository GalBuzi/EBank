...
import * as accountRepository from '../../src/repositories/SQLRepository/account.repository.js';
import { expect } from 'chai';
import { IAccountModel, IAddressModel, IIndividualAccountModel } from '../../src/types/models.types';
import * as addressRepository from '../../src/repositories/SQLRepository/address.repository.js';
import * as individualRepository from '../../src/repositories/SQLRepository/individual.repository.js';
...
describe("Testing creating an account", () =>{
    it("Should create a new individual account and return the DTO", async ()=>{
        ...
        const created_account = await builderSQL.createIndividualAccount(individualModel);
        expect(created_account).to.deep.equal(individualDto);
    })
})