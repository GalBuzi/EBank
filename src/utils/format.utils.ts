...
class Formatter {
  ...
  formatDataToFamilyDTO(element: RowDataFamily): IFamilyAccounBaseDTO {
...
export const myMap: IMapStringToFunc = {
  formatToIndividualDTO: instance.formatToIndividualDTO,
  formatToBusinessDTO: instance.formatToBusinessDTO,
  formatDataToFamilyDTO: instance.formatDataToFamilyDTO,
};
