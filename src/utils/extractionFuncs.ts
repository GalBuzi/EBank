...
function extractAccountRecord(model: ModelsWithAccounts): IAccountRecord {
...
function extractAddressRecord(model: ModelsWithAddress): IAddressRecord {
...
function extractIndividualRecord(model: IIndividualAccountModel): IIndividualAccountRecord {
...
function extractBusinessRecord(model: IBusinessAccountModel): IBusinessAccountRecord {
...
function extractFamilyRecord(model: IFamilyAccountModel): IFamilyAccountRecord {
...
function extractOwnersIds(model: IFamilyAccountModel): number[] {
